...
class AdminView extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        title: Obx(() {
          if (controller.tabIndex.value == 0)
            return Text("Pesanan Aktif",
                style: GoogleFonts.poppins(fontWeight: FontWeight.bold));
          if (controller.tabIndex.value == 1)
            return Text("Riwayat Pesanan",
                style: GoogleFonts.poppins(fontWeight: FontWeight.bold));
          return Text("Pengaturan Admin",
              style: GoogleFonts.poppins(fontWeight: FontWeight.bold));
        }),
  ...
  Widget _buildOrderList(
      List<Map<String, dynamic>> orders, AdminController controller,
  ...
  Widget _buildOrderCard(BuildContext context, Map<String, dynamic> item,
    ...
    if (status == 'Sampai Tujuan' || status == 'Selesai')
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Detail Pesanan
            _rowDetail(
                Icons.local_laundry_service, "Layanan", item['layanan'] ?? "-"),
            _rowDetail(Icons.note, "Items", item['berat_items'] ?? "-"),
            _rowDetail(
                Icons.location_on, "Alamat", item['alamat_lengkap'] ?? "-"),
            ...
            if (!isCompleted)
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () =>
                      _showStatusBottomSheet(context, item['id'], controller),
  ...
  void _showStatusBottomSheet(
      BuildContext context, int id, AdminController controller) {
    Get.bottomSheet(
        Container(
          color: Colors.white,
          padding: const EdgeInsets.all(20),
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _statusButton(
                    "Sedang Disetrika", Colors.purple, id, controller),
                ...
                ListTile(
                  ...
                  title: Text("Diantar Kurir",
                      style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
                  trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                  onTap: () => _showCourierInputDialog(context, id, controller),
                ),
                _statusButton("Sampai Tujuan", Colors.teal, id, controller,
                    icon: Icons.home),
                _statusButton(
                    "Selesai (Sudah Diambil)", Colors.grey, id, controller,
                    value: "Selesai", icon: Icons.check_circle),
              ],
            ),
          ),
        ),
  ...
  Widget _statusButton(
      String label, Color color, int id, AdminController controller,
  ...
  void _showCourierInputDialog(
    ...
    Get.defaultDialog(
        ...
        content: Padding(
            padding: const EdgeInsets.all(10),
            child: TextField(
                controller: controller.courierC,
                decoration: const InputDecoration(
                    hintText: "Contoh: Budi", border: OutlineInputBorder()))),
        textConfirm: "Simpan",
        confirmTextColor: Colors.white,
        buttonColor: Colors.blue,
        onConfirm: () {
          if (controller.courierC.text.isNotEmpty)
            controller.updateStatus(id, "Diantar Kurir",
                namaKurir: controller.courierC.text);
        },
        textCancel: "Batal");
  }
  ...
  void _showChangeEmailDialog(AdminController controller) {
    ...
    Get.defaultDialog(
        ...
        textConfirm: "Simpan",
        confirmTextColor: Colors.white,
        onConfirm: controller.updateEmail,
        textCancel: "Batal");
  }
  ...
  void _showChangePasswordDialog(AdminController controller) {
    ...
    Get.defaultDialog(
        ...
        textConfirm: "Simpan",
        confirmTextColor: Colors.white,
        onConfirm: controller.updatePassword,
        textCancel: "Batal");
  }
